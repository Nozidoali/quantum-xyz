...
"""
Author: Hanyu Wang
Created time: 2023-09-13 09:54:16
Last Modified by: Hanyu Wang
Last Modified time: 2023-09-13 10:39:19
"""
...
class LdmcuDecompose:
    ...
    def _c1c2(self, unitary, n_qubits, gate_circ, first=True, step=1):
        ...
        for pair in qubit_pairs:
            ...
            if pair.target == n_qubits - 1 and first:
                ...
                gate_circ.compose(
                    csqgate, qubits=[pair.control, pair.target], inplace=True
                )
            else:
    ...
    def ldmcu(circuit, unitary, controls, target, ctrl_state=None):
        circuit.append(
            Ldmcu(unitary, len(controls), ctrl_state=ctrl_state), [*controls, target]
        )
