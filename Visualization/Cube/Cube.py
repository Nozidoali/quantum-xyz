...
def print_cube(states: List[int], filename: str):
    ...
    ax.scatter(points_x, points_y, points_z, c='red', edgecolors='red', s=100, alpha=1, depthshade=False, linewidth=3.0)
    ...
    for edge in edges:
        ...
        ax.plot([start[0], end[0]], [start[1], end[1]], [start[2], end[2]], color='black', linewidth=3.0)
