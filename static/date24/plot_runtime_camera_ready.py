...
# change plt font family to Serif
...
# figure margin
plt.subplots_adjust(left=0.22, right=0.95, top=0.96, bottom=0.11)

font_size = 24

# set y x title, with Times New Roman font
plt.ylabel("Runtime (s)", fontsize=font_size, fontname="serif")
plt.xlabel("Number of qubits", fontsize=font_size, fontname="serif")


# ticks font size
plt.xticks(fontsize=font_size, fontname="serif")
plt.yticks(fontsize=font_size, fontname="serif")
...
# plot the legend
ax.legend(handles=handles, labels=labels, fontsize=font_size, loc="lower right")
...
# save the figure
if DENSE:
    plt.savefig("runtime_dense_state_camera_ready.pdf", bbox_inches="tight")
else:
    plt.savefig("runtime_sparse_state_camera_ready.pdf", bbox_inches="tight")
